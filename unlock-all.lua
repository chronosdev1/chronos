if getgenv().__chronosUnlockActive then return end
getgenv().__chronosUnlockActive = true
...
local function Notify(title, content, duration)
    ...
    task.spawn(function()
        pcall(function()
            ...
            local gui = parent:FindFirstChild("Chronos_Notifications")
            if not gui then
                gui = Instance.new("ScreenGui")
                gui.Name = "Chronos_Notifications"
            ...
            gradient.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(26, 29, 38)),
